...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (session('id'))
                            ...
                            <li class="nav-item">
                                <a href="{{route('logSession.show')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('book.show') }}" class="nav-link">
                                    ...
                                    {{-- <i class="fa-thin fa-books-medical"></i> --}}
                                    <p>
                                        Add Book
                                    </p>
                                </a>
                        ...
                        @if (session('admin_id'))
                            ...
                            <li class="nav-item">
                                ...
                                <a href="{{ route('student.logoutStudent') }}" class="nav-link">
                                    <i class="nav-icon fas fa-power-off"></i>
                                    <p>
                                        Logout
                                    </p>
    ...
    <script>
        $(function() {
            $('.is-trainee-block').change(function() {
                var status = $(this).prop('checked') == true ? 1 : 0;
                var trainee_id = $(this).data('id');
